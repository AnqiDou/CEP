IF OBJECT_ID ('dbo.user_profiles', 'U') IS NULL BEGIN
...
IF OBJECT_ID ('dbo.item_details', 'U') IS NULL BEGIN
...
IF NOT EXISTS (
    ...
    FROM sys.indexes
    WHERE
        name = 'idx_item_details_item'
        AND object_id = OBJECT_ID ('dbo.item_details')
) BEGIN
...
ADD credit_score DECIMAL(10, 1) NOT NULL DEFAULT 100.0;

END;
GO

ALTER TABLE user_profiles
ALTER COLUMN credit_score DECIMAL(10, 1) NOT NULL;
GO
