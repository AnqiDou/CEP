...
import com.example.cep_backend.publish.service.TencentCosProperties;
...
public class ProfileImageService {
    ...
    public ProfileImageService(TencentCosProperties properties) {
    ...
    public String upload(MultipartFile file) {
        ...
        try (InputStream stream = file.getInputStream()) {
            ...
            throw new BusinessException("上传头像失败，请稍后重试");
        } finally {
            cosClient.shutdown();
        }
    }
    ...
    private void validateImage(MultipartFile file) {
        ...
        if (file.getSize() > MAX_IMAGE_SIZE) {
            throw new BusinessException("头像图片大小不能超过 10MB");
        }
    ...
    private String buildObjectKey(String originalFilename) {
        ...
        return "profile-avatars/" + dateFolder + "/" + UUID.randomUUID() + extension;
    }
